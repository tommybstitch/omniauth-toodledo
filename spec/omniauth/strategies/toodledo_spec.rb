...
describe OmniAuth::Strategies::Toodledo, :type=>:strategy do
  ...
  def strategy
    ...
    [OmniAuth::Strategies::Toodledo, { :app_id => app_id,
                                       :app_token => app_token }]
  end
  ...
  describe '#client_options' do
    it 'has correct Toodledo site' do
      subject.options.client_options.site.should eq ('https://api.toodledo.com')
    end
    ...
    it 'has correct Toodledo account info url' do
      (subject.options.client_options.site +
        subject.options.client_options.account_info_path).should eq (
          'https://api.toodledo.com/2/account/get.php'
        )
...
=end
  ...
  describe 'POST /auth/toodledo/callback' do
    before do
      url = 'https://api.toodledo.com/2/account/lookup.php?appid=1224;email=tood5@log4d.com;pass=123456;sig=ea5f3ecf7537b1f22fe884acd5e0c6d1'
      stub_request(:get, url) .to_return(
        :body => '{"userid": "td4ff814c167430"}'
      )
      url = 'https://api.toodledo.com/2/account/token.php?userid=td4ff814c167430;appid=1224;pass=123456;sig=249d70aa59f88892e5936999237bc2bb'
      stub_request(:get, url) .to_return(:body => '{"token": "1a0000005e6f7"}')
      url = 'https://api.toodledo.com/2/account/get.php?key=2f74098076e87ea129b44c0431684040'
